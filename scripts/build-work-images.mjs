...
const sources = [
  ...
  ['lost-ark', '導演功課/導演作品集/York挑圖_完整80案圖庫_2026-08-11/00_把喜歡的圖放這裡/失落的方舟/03_使命篇/frame-21-t10.000.png'],
  ...
  ['earth-revival', '導演功課/導演作品集/York挑圖_完整80案圖庫_2026-08-11/00_把喜歡的圖放這裡/星球重啟/04_末日只能帶一樣篇/frame-41-t20.000.png'],
  ['street-basketball', '導演功課/導演作品集/York挑圖_完整80案圖庫_2026-08-11/00_把喜歡的圖放這裡/街頭籃球2：正宗續作/01_默契主場篇/frame-01-t0.000.png'],
  ['hot-blooded-jianghu', '導演功課/導演作品集/York挑圖_完整80案圖庫_2026-08-11/00_把喜歡的圖放這裡/熱血江湖：歸來/02_李雅英篇/frame-03-t1.000.png'],
...
console.log(JSON.stringify({ built: manifest.length, outputDir, ogPath, manifestPath }, null, 2));
